...
#ifndef H_BITON_SCRIPT
#define H_BITON_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CBitonAddress
 */
...
public:
    ...
    // Pre-version-0.6, Biton always counted CHECKMULTISIGs
