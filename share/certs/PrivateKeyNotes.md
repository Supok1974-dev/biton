...
unlocked to sign the Biton-Qt.app bundle.
...
allowing somebody to distribute a Biton-Qt.app or biton-qt-setup.exe with a valid
...
that the biton-qt.exe file inside the installer had not been tampered with.
